        ...
        <!-- ============================================================== -->
         <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="#">Mauli Cake Shop</a>
                    	...
                    	<div class="card">
                    		<div class="card-body">
                    			<div class="text-secondary font-italic m-3">
                                    <p>
                                        The Cake Shop was founded by a Mr. Rohit Pandavale of passionate and dedicated bakers who are committed in baking the most delicious cakes and pastries around. Using only the freshest ingredients we can find, you can be sure that you are served the best quality cake you can ever have.
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                        Our online store is a leading online shop in Latur providing cakes and gifts deliveries within Latur. We provide competitive prices, good after sales services and on-time delivery.
                                    </p>
                                    <p>
                                        The Cake Shop provides same day delivery service seven days a week, including Sunday, within Latur to provide a high level of customer service.
                                    </p>
                                    <p>
                                        Bon Appetite!!
                                    </p>
                                    <p>
                                        The Mauli Cake Shop Team
                                    </p>
                                </div>
                    		</div>
                    	</div>
